# -*- coding: utf-8 -*-
#
# picage documentation build configuration file, created by
...
version = picage.__version__
# The full version, including alpha/beta/rc tags.
release = picage.__version__
...
html_logo = "./_static/picage-logo.png"
html_favicon = "./_static/picage-favicon.ico"
...
latex_documents = [
    (master_doc, 'picage.tex', 'picage Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'picage', 'picage Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'picage', 'picage Documentation',
     author, 'picage', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from picage.docs import doc_data
except:
    doc_data = dict()
